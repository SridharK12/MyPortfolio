...
"""
Single-File Professional RAG with Conversational Memory + PII Guardrails + Token Tracking
...
- Guardrails to mask SSN, credit card numbers, and phone numbers from responses
...
def mask_pii(text: str) -> str:
    ...
    return mask_phone_numbers(mask_credit_cards(mask_ssn(text)))
...
if __name__ == "__main__":
    ...
    q2 = "Are they the same drops as you mentioned earlier?"
