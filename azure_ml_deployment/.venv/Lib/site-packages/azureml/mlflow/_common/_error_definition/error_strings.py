...
class AzureMLErrorStrings:
    ...
    class UserErrorStrings:
        ...
        TIMEOUT_FLUSH_TASKS = "Failed to flush task queue within {timeout_seconds} seconds. Please set " \
                              "AZUREML_ARTIFACTS_DEFAULT_TIMEOUT environment variable to increase the timeout(in " \
                              "seconds) "
