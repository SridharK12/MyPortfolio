...
class ServicesOperations:
    ...
    async def query_by_id(
        ...
        include_health: Optional[bool] = True,
        **kwargs
    ) -> "models.ServiceResponseBase":
        """Get a Service.
    ...
    async def create_put(
        ...
        workspace: str,
        id: str,
        body: "models.CreateServiceRequest",
        **kwargs
    ) -> None:
        """Create a Service.
    ...
    async def patch(
        ...
        workspace: str,
        id: str,
        body: List["models.JsonPatchOperation"],
        **kwargs
    ) -> None:
        """Patch a Service.
    ...
    async def delete(
        ...
        id: str,
        **kwargs
    ) -> Optional["models.ProblemDetails"]:
        """Delete a Service.
    ...
    async def resource_validation(
        ...
        resource_group: str,
        workspace: str,
        body: "models.ServiceValidateResourceRequest",
        **kwargs
    ) -> Union["models.ServiceResponseBase", "models.ProblemDetails"]:
    ...
    async def export_query_post(
        self,
        subscription_id: str,
        resource_group: str,
        workspace: str,
        body: Optional["models.ExportServicesRequest"] = None,
        **kwargs
    ) -> None:
    ...
    def list_query(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.machinelearningservices.models.PaginatedServiceList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_query_post(
        ...
        resource_group: str,
        workspace: str,
        body: Optional["models.ListServicesRequest"] = None,
        **kwargs
    ) -> AsyncIterable["models.PaginatedServiceListPost"]:
        """Query the list of Services in a Workspace.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.machinelearningservices.models.PaginatedServiceListPost]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def regenerate_service_keys(
        self,
        subscription_id: str,
        resource_group: str,
        workspace: str,
        id: str,
        body: "models.RegenerateServiceKeysRequest",
        **kwargs
    ) -> None:
    ...
    async def request_validation(
        ...
        resource_group: str,
        workspace: str,
        body: "models.ValidateServiceRequest",
        **kwargs
    ) -> Union["models.ServiceResponseBase", "models.ProblemDetails"]:
