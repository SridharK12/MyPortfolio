...
class OnlineEndpointsOperations:
    ...
    async def create(
        ...
        workspace: str,
        name: str,
        body: "models.PutOnlineEndpointRequest",
        **kwargs
    ) -> "models.OnlineEndpointResponseBase":
    ...
    async def query(
        ...
        resource_group: str,
        workspace: str,
        body: Optional["models.ListOnlineEndpointsRequest"] = None,
        **kwargs
    ) -> "models.OnlineEndpointResponseBase":
    ...
    async def regenerate_keys(
        ...
        workspace: str,
        name: str,
        body: Optional["models.RegenerateServiceKeysRequest"] = None,
        **kwargs
    ) -> Optional["models.AuthKeyResult"]:
        """Get a list of OnlineEndpoints.
