...
class ProfilesOperations:
    ...
    async def query_by_id(
        ...
        **kwargs
        ...
        :return: ProfileResponse, or the result of cls(response)
        :rtype: ~azure.mgmt.machinelearningservices.models.ProfileResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ProfileResponse"]
        error_map = {
        ...
        return deserialized
    query_by_id.metadata = {'url': '/modelmanagement/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.MachineLearningServices/workspaces/{workspace}/images/{imageId}/profiles/{id}'}  # type: ignore
    ...
    def list_query(
        ...
        **kwargs
    ) -> AsyncIterable["models.PaginatedProfileResponseList"]:
        """Get a list of Image Profiles.

        If no filter is passed, the query lists all Profiles for the Image. The returned list is
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either PaginatedProfileResponseList or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.machinelearningservices.models.PaginatedProfileResponseList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.PaginatedProfileResponseList"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize('PaginatedProfileResponseList', pipeline_response)
    ...
    list_query.metadata = {'url': '/modelmanagement/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.MachineLearningServices/workspaces/{workspace}/images/{imageId}/profiles'}  # type: ignore
    ...
    async def create(
        ...
        workspace: str,
        image_id: str,
        body: "models.ProfileRequestBase",
        **kwargs
    ) -> None:
        """Create a Profile.
        ...
        :type body: ~azure.mgmt.machinelearningservices.models.ProfileRequestBase
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    create.metadata = {'url': '/modelmanagement/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.MachineLearningServices/workspaces/{workspace}/images/{imageId}/profiles'}  # type: ignore
