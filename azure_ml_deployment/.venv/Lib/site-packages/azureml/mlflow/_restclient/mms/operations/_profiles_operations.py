...
class ProfilesOperations(object):
    ...
    def list_query(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.PaginatedProfileResponseList"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.machinelearningservices.models.PaginatedProfileResponseList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def create(
        ...
        workspace,  # type: str
        image_id,  # type: str
        body,  # type: "models.ProfileRequestBase"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        """Create a Profile.
